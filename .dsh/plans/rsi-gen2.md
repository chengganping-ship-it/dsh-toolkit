...
3. dsh-tool-rsi-50754290
   - members: dsh-tool-fx-rates.convert + dsh-tool-unit-convert.convert
   - RSI pipeline [50754290]: dsh-tool-fx-rates.convert -> dsh-tool-unit-convert.convert (complements)
