...
// dsh-tool-date-math.calc -> dsh-tool-loan-calc.calc
const STAGE_A = 'dsh-tool-date-math.calc';
const STAGE_B = 'dsh-tool-loan-calc.calc';
const STAGE_A_DIR = 'dsh-tool-date-math';
...
export default {
  async apply(ctx: PluginContext) {
    ctx.defineTool({
      name: 'pipeline',
      description:
        'RSI pipeline: runs dsh-tool-date-math.calc then dsh-tool-loan-calc.calc. Input JSON passed to stage A.',
