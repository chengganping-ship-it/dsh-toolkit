// Generated by DSH RSI harvester - generic probe adapter for "shortid"
...
export default {
  async apply(ctx: PluginContext) {
    ctx.defineTool({
      name: 'probe',
      description: "Introspect external package shortid: list exports and invoke the default export when callable.",
      handler: async (inputData: string) => {
        try {
          const mod: any = require("shortid");
