// Generated by DSH RSI harvester - generic probe adapter for "yaml-eslint-parser"
...
export default {
  async apply(ctx: PluginContext) {
    ctx.defineTool({
      name: 'probe',
      description: "Introspect external package yaml-eslint-parser: list exports and invoke the default export when callable.",
      handler: async (inputData: string) => {
        try {
          const mod: any = require("yaml-eslint-parser");
